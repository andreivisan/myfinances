package io.programminglife.myfinances.util.csv;
...
public class CSVUtil {
    ...
    public static Expense csvEntityToExpense(CsvEntity csvEntity, Category category, 
        PaymentSystem paymentSystem, Client client) {
